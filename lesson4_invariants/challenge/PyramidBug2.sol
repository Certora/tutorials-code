...
/**
 * @title A buggy version of the Pyramid contract - disconnect the grandfather
 */
contract PyramidBug2 {
  ...
  function join(address child, bool isRight) memebersOnly() public {
    ...
    memberData.parent = address(0);  // Bug - disconnect the grandfather
