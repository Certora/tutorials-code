...
contract ERC4626InflationAttack is ERC20 {
    ...
    function deposit(uint256 assets, address receiver) public virtual returns (uint256 shares) {
        ...
        //Commented out to make the contract vulnerable to inflation attack

        //Added minimal change required for the InflationAttack to work.
    ...
    function redeem(
        ...
        //Don't check for rounding errors to allow inflation attack.
    ...
    //Logic added for Certora Prover. TODO remove as cleanup of specs/ERC4626-FunctionalAccountingProps.spec.
    function getUserBalance(address addr) external view returns (uint256) {
